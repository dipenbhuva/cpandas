...
- Optional SIMD and OpenMP acceleration for dense numeric reductions with C fallback.
...
CpDataFrame *numeric_view =
    cp_df_select_dtypes_view(df, numeric, 2, NULL, 0, &err);
